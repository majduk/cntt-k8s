...
This document summarizes the [requirements](https://github.com/cntt-n/CNTT/blob/master/doc/ref_arch/kubernetes/chapters/chapter02.md) to the kubernetes architecture and refeneres to the deployed model.
